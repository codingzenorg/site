...
This repo deploys through GitHub Actions on `main`. The workflow builds Shesha, stages it into `apps/shesha`, builds the site, and publishes the final `dist/` artifact to GitHub Pages.
